...
\location{CGPA: \bold{9.48/10} (upto 5th sem)}
...
\location{Familiar:}
\textbullet{} Java \textbullet{} JavaScript %\textbullet{} PHP \\
\sectionsep
...
\runsubsection{IGNUS} | 
\descript{MVC Driven Platform For Annual College Festival}
\location{Oct 2018 - Feb 2019 | Jodhpur, India}
\begin{tightemize}
...
\location{\href{https://github.com/hirenchalodiya1/gymkhana_portal}{\underline{Project Link}} | Jodhpur, India}
\begin{tightemize}
